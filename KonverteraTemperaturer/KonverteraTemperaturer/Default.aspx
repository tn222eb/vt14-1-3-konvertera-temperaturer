    ...
    <form id="form1" runat="server" defaultbutton="SubmitButton">
        ...
        <div>
            ...
            <asp:CompareValidator ID="CompareValidator4" runat="server"
                    ControlToValidate="FinalTemperatureTextBox" ControlToCompare="StartingTemperatureTextBox" Operator="GreaterThanEqual" Type="Integer" ErrorMessage="Sluttemperaturen måste vara högre än starttemperaturen" Display="Dynamic" Text="*" CssClass="field-validation-error"></asp:CompareValidator>    
        </div>
        <div>
            ...
            <asp:RadioButton ID="CelciusToFahrenheit" Text="Celcius till Fahrenheit" runat="server" GroupName="RadioButton" /> <br />
